...
export default function Catalogue() {
  ...
  // Calculate min and max price rounded nicely
  ...
  return (
    <main className="min-h-screen bg-[#050505] relative text-white">
      ...
      <div className="relative max-w-7xl mx-auto px-8 sm:px-16 py-12 pt-24">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {filterCars.length === 0 ? (
            <p className="text-center col-span-full text-lg text-gray-400">Geen auto's gevonden die aan je filters voldoen.</p>
          ) : (
            filterCars.map((car) => (
              <article key={car.id} className="bg-[#111] rounded-lg shadow-lg overflow-hidden">
