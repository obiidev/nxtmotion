import { opties } from '@/data/opties4';

export default function OptionsTable4() {
  return (
    <div className="flex flex-col p-6 mx-auto w-full text-center text-gray-100 bg-transparent h-full">
      <h3 className="mb-6 text-xl font-semibold sm:block hidden text-white">
        Prestaties & Sportfuncties
      </h3>
      {/* List */}
      <div className="flex justify-center w-full">
        <ul role="list" className="space-y-2 text-left flex-grow w-full max-w-sm">
          {opties.map((optie) => (
            <li
              key={optie.functie}
