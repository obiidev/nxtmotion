      ...
      >
        <div className="max-w-md ml-auto">
          ...
          <p className="text-white text-base sm:text-lg mb-6 opacity-90 text-right">
              Ontdek onze selectie van betrouwbare, stijlvolle en rijk uitgeruste voertuigen. 
  Elke auto is met zorg geselecteerd om jou kwaliteit en rijplezier te garanderen.
          </p>
